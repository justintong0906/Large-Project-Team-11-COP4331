...
function LoginBox({setShowLogin}){
    return(
        <div className="LoginBox">
            <h2 class="lbContent" style={{fontSize:"2.2rem", marginTop: "0"}}>Log in</h2>
            <div class="lbContent">
                <input class="textbox" placeholder="Email" style={{marginBottom:"5px"}}></input>
                <input class="textbox" placeholder="Password" type="password"></input>
            </div>
            <button class="lbContent LoginButton">Log in</button>
            <div class="lbContent">
...
function SignupBox({setShowLogin}){
    return(
        <div className="LoginBox">
            <h2 class="lbContent" style={{fontSize:"2.2rem", marginTop: "0"}}>Sign up</h2>
            <div class = "lbContent">
                <input class="textbox" placeholder="Email" style={{marginBottom:"5px"}}></input><br/>
                <input class="textbox" placeholder="Password " type="password" style={{marginBottom:"5px"}}></input><br/>
                <input class="textbox" placeholder="Confirm Password" type="password"></input>
            </div>
            <button class="lbContent LoginButton">Sign up</button>
